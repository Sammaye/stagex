...
<div class='video clearfix <?php echo isset($extra_classes) ? $extra_classes : '' ?>' data-id='<?php echo $model ? strval($model->_id) : '' ?>' data-ts='<?php echo $last_ts ?>' style='position:relative;'>
	...
	<img alt='<?php echo Html::encode($model->title) ?>' src="<?php echo $model->getImage(88, 49) ?>"/></a></div>		
	<div class='info'>

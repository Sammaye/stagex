...
<div class="rated_videos_body">
	...
	<div class="advanced_filter_header">   
		...
		<label class="sr-only" for="query">Search Query</label>
			...
			<input type="text" id="from" class="date form-control" name="from_date" placeholder="Enter start date" value="<?php echo htmlspecialchars(glue::http()->param('from_date',null)) ?>"/>
			<span class="sep">-</span>
			...
			<div class="col-md-2 form-inline-col"><button type="submit" class="btn btn-default">Search</button></div>

...
class LinkedIn {
  ...
  function getRequestToken() {
    ...
    return array("oauth_token"=>$response_params['oauth_token'], "oauth_token_secret"=>$response_params['oauth_token_secret']);
  }

  function setRequestToken($oauth_token = null, $oauth_token_secret = null){
	$this->request_token = new OAuthConsumer($oauth_token, $oauth_token_secret, 1);
  }
  ...
  function setAccessToken($oauth_token = null, $oauth_token_secret = null){
  	$this->access_token = new OAuthConsumer($oauth_token, $oauth_token_secret, 1);
  }

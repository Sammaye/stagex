...
class Document extends Model{
	 ...
	 * @param $_id
	 */
	public static function findBy_id($_id,$fields=array()){
		$this->trace(__FUNCTION__);
	 ...
	 * @param $pk
	 */
	public static function findByPk($pk,$fields=array()){
		$this->trace(__FUNCTION__);
	 ...
	 * @param $options
	 */
	public static function deleteByPk($pk,$criteria=array(),$options=array()){
		$this->trace(__FUNCTION__);
	 ...
	 * @param array $options
	 */
	public static function updateByPk($pk, $updateDoc = array(), $criteria = array(), $options = array()){
		$this->trace(__FUNCTION__);
	 ...
	 * @param array $options
	 */
	public static function updateAll($criteria=array(),$updateDoc=array(),$options=array('multiple'=>true)){
		$this->trace(__FUNCTION__);
	 ...
	 * @param array $options
	 */
	public static function deleteAll($criteria=array(),$options=array()){
		$this->trace(__FUNCTION__);

...
<<?php if(isset($useLiTag)&&$useLiTag): echo 'li'; else: echo 'div'; endif; ?> 
	...
	<?php if(isset($show_sorter)&&$show_sorter): ?><div style='float:left;padding-top:18px;width:15px;margin:0 5px 0 5px;cursor:pointer;' class='sortable_handle'><img alt='sort' src='/images/sortable_icon.png'/></div><?php endif; ?>
